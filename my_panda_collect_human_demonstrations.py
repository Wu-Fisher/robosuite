...
# from draw_test import AccDrawer
from sendtest import send_acc_data
...
def collect_human_trajectory(env, device, arm):
    ...
    while True:
        ...
        # print(f"left_finger_tip_accel: {env.sim.data.sensor('gripper0_right_accel_left_finger_tip')}")
        # print(f"right_finger_tip_accel: {env.sim.data.sensor('gripper0_right_accel_right_finger_tip')}")
        # exit()
        send_acc_data(env.sim.data.sensor('gripper0_right_accel_left_finger_tip').data)
